// 대시보드 핸들러 함수 — dashboard.ts 라우트에서 분리
...
export async function handleStats(
  request: FastifyRequest<{ Params: IdParams; Querystring: StatsQuery }>,
) {
  const { id } = request.params;
...
/** GET /:id/dashboard/file-changes 핸들러 — 파일별 변경 빈도 */
...
/** GET /:id/dashboard/usage 핸들러 — 사용자별 세션/메시지/비용 집계 */
