  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#F5F5EF' }}>
      <div className="text-center px-6 py-10 max-w-md">
        ...
        <img src="/logo.png" alt="Nexus 로고" width={120} height={40} className="mx-auto mb-8 object-contain" />

        <div className="text-6xl font-bold mb-4" style={{ color: '#E0845E' }}>404</div>
